...
using ConsultApp.iOS.Helpers.CustomRenderers;
using CoreAnimation;
using CoreGraphics;
using UIKit;
using Xamarin.Forms;
...
[assembly: ExportRenderer(typeof(CustomFrame), typeof(CustomFrameiOS))]
namespace ConsultApp.iOS.Helpers.CustomRenderers
{
